        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('admin.menus.index') }}"
                    class="px-6 py-3 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-black hover:text-white text-lg border border-black">Menu Update</a>
            </div>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.menus.update', $menu->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <br>
                            <button type="submit" class="px-6 py-3 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-black hover:text-white text-lg border border-black">Update</button>
                        </div>
                    </form>
                </div>
            </div>
