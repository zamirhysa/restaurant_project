    ...
    <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="flex-m-2 p-2">
                     <a href="{{route ( 'admin.categories.index')}}" class="px-6 py-3 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-black hover:text-white text-lg border border-black">Category</a>
                </div>
